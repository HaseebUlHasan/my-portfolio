        ...
        <Col lg="8">
          <Card style={{ textAlign: "justify", backgroundColor: "#f565394d" }}>
            <Card.Body>
              <Card.Title>
                {" "}
                <SchoolIcon fontSize="large" /> Bachelor of Software Engineering
              </Card.Title>
              <Card.Text>
          ...
          <Card style={{ textAlign: "justify", backgroundColor: "#f565394d" }}>
            <Card.Body>
              <Card.Title>
                {" "}
                <SchoolIcon fontSize="large" /> Higher Secondary Education{" "}
              </Card.Title>
              <Card.Text>
          ...
          <Card style={{ textAlign: "justify", backgroundColor: "#f565394d" }}>
            <Card.Body>
              <Card.Title>
                {" "}
                <SchoolIcon fontSize="large" /> Secondary Education
              </Card.Title>
              <Card.Text>
